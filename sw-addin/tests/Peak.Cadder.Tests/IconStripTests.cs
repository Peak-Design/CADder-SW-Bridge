...
namespace Peak.Cadder.Tests
{
    ...
    public class IconStripTests
    {
        ...
        public void EveryStripHoldsOneIconPerCommandAtItsSize()
        {
            ...
            {
                var strip = PngSize(Path.Combine(dir, "Cadder_" + size + ".png"));
        ...
        public void EveryGroupIconIsSquareAtItsSize()
        {
            ...
            foreach (int size in Sizes)
            {
                var main = PngSize(Path.Combine(dir, "CadderMain_" + size + ".png"));
        ...
        private static string IconsDir()
        {
            ...
            while (dir != null)
            {
                string candidate = Path.Combine(dir, "src", "Peak.Cadder", "icons");
                if (Directory.Exists(candidate)) return candidate;
                dir = Path.GetDirectoryName(dir);
            }
            throw new DirectoryNotFoundException("src/Peak.Cadder/icons above " + AppContext.BaseDirectory);
        }
