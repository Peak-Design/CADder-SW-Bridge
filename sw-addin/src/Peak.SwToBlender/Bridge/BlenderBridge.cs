...
{
    /// <summary>One running Blender with the STEPper NEXT bridge listening.</summary>
    ...
    public static class BlenderBridge
    {
            ...
            string exe, Action<string> log, int timeoutMs = 120000)
        {
            ...
            throw new TimeoutException(
                "Blender started but its STEPper NEXT bridge did not come up "
                + "within " + (timeoutMs / 1000) + "s. Is STEPper NEXT installed "
